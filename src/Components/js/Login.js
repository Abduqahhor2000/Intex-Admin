    ...
    return (
        <>   
            ...
            <div className="absolute flex flex-col w-2/3 bottom-1/2 right-1/2 translate-x-1/2 translate-y-1/2 bg-slate-100 p-12 pt-9 rounded-3xl w-155"> 
                ...
                {
                    isLoading ? <span className="block flex justify-center w-60 mx-auto h-12 rounded-2xl py-3 text-center text-white font-semibold mt-8 cursor-pointer bg-blue-green"> 
