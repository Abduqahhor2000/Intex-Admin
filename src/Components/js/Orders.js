            ...
            <div className="products-table min-h-screen px-10 py-6">
                ...
                <div className="table w-full pt-3">
                    <div className="product-type flex justify-center items-center mb-10"> 
                        <span className={`type cursor-pointer text-4xl ml-5 py-4 font-bold text-center ${orderName === "sales" ? "active" : ""}`} onClick={() => setOrderName("sales")}>
                            Заказы
                        </span>
                        <span className={`type cursor-pointer text-4xl ml-5 py-4 font-bold text-center ${orderName === "consultation" ? "active" : ""}`} onClick={() => setOrderName("consultation")}>
                            Консультации
                        </span>   
                    </div>
                    {
