        ...
        <>
            <div className="px-10 py-6">
                <div className="flex justify-end items-center">
                    <div className="h-16 rounded-3xl py-4 px-3 text-center text-xl font-middle text-white shadow-lg cursor-pointer  transition ease-in-out delay-150 hover:-translate-y-5 hover:scale-110 duration-300 " style={{"background-color": "rgb(0, 147, 152)"}}>
                        + Добавить категории 
                    </div>
                </div>
                                ...
                                return (
                                    <>
                                        <tr className="bg-white">
                                            <td className="rounded-l-3xl py-4 pl-11">{item.name}</td>
                                            <td className="py-4 text-center">{item.name_uz}</td>
                                            <td className="py-4 rounded-r-3xl pr-11">
                                                <div className="flex justify-end">
                                                    <span onClick={() =>{ setCategoryMadal(true); setCategoryInfo({name: item.name, name_uz: item.name_uz})}} className="p-2 cursor-pointer">
                                                    ...
                                                    <span onClick={() => setCategoryMadal("del")} className="p-2 ml-2 cursor-pointer">
            ...
            <CategorySectionMadal categoryMadal={categoryMadal} setCategoryMadal={setCategoryMadal} categoryInfo={categoryInfo} setCategoryInfo={setCategoryInfo} />
        </>
    )
}