...
export default function SiteSectionMadal({typeMadal, setTypeMadal, typeInfo}) {
    ...
    const updateSiteInfo = async () => {
        try{   
            ...
            // if(typeMadal === "phoneNumber"){

            // } else if(typeMadal === "address"){

            // } else if(typeMadal === "workTime"){

            // } else if(typeMadal === "telegramLink"){

            // } else if(typeMadal === "instagramLink"){
                    ...
                    <>{
                        (statusReq === null) ? 
                            <>
                                ...
                                <span onClick={()=>{updateSiteInfo()}} className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-1.5" style={{"backgroundColor" : "rgba(0, 147, 152, 1)"}}>Изменить</span>
                            </> 
                            : completeMadal
                    }</> :
