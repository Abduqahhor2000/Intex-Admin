...
export default function SiteSectionMadal({typeMadal, setTypeMadal, typeInfo}) {
    ...
    return(
        <>
            <div onClick={()=> setTypeMadal(null)} className="fixed z-10 top-0 left-0 w-screen h-screen bg-black-02 backdrop-blur"></div>
            <div className="fixed z-10 flex flex-col justify-between items-center w-2/3 h-96 bottom-1/2 right-1/2 translate-x-1/2 translate-y-1/2 bg-slate-100 p-12 pt-6 rounded-3xl">
                ...
                </span>
                {
                    ...
                    <>{
                        (statusReq !== "complate") ? 
                            <>
                                <h2 className="text-5xl text-blue-green">Телефонный номер</h2>
                                <div className="w-96">
                                ...
                                {
                                    statusReq !== "active" 
                                        ? <span onClick={()=>{updateSiteInfo()}} className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-1.5 bg-blue-green">Изменить</span>
                    ...
                    <>{
                        (statusReq !== "complate") ? 
                            <>
                                <h2 className="text-5xl text-blue-green">Адрес</h2>
                                ...
                                {
                                    statusReq !== "active" ? <span onClick={()=>{updateSiteInfo()}} className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-1.5 bg-blue-green">Изменить</span>
                                                           : <span className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-3.5 bg-blue-green">
                                                                <svg className="animate-spin mr-3 ml-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                                                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    ...
                    <>{
                        (statusReq !== "complate") ? 
                            <>
                                <h2 className="text-5xl text-blue-green">Рабочее время</h2>
                                <div className="w-full flex justify-around">
                                    <label className="relative text-xl w-96 text-gray-500 pb-4">Название<br/>
                    ...
                    <>{
                        (statusReq !== "complate") ? 
                            <>
                                <h2 className="text-5xl text-blue-green">Телеграм</h2>
                                <div className="w-96">
                    ...
                    <>{
                        (statusReq !== "complate") ? 
                            <>
                                <h2 className="text-5xl text-blue-green">Инстаграм</h2>
                                <div className="w-96">
                                    <label className="relative text-xl w-full text-gray-500 pb-5">Линк<br/>
