                    ...
                    <>
                        ...
                        <div className="flex justify-between flex-wrap px-9">
                            ...
                            <div className="relative flex flex-col pl-10 mx-5 mb-3">
                                ...
                                <input value={quantity} min={0} onChange={(e) => {setQuantity(e.target.value)}} type="number" className={`w-96 h-12 text-3xl text-slate-600 outline-none border-b-2 border-solid ${(notRequer && ((quantity < 0) || (quantity === ""))) ? "border-red-500" : "border-slate-600"}`}/>
                            </div>
                            <div className="relative flex flex-col pl-10 mx-5 mb-3">
