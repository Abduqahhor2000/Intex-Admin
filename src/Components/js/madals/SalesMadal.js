...
export default function SalesMadal({saleID, setSaleID}) {
    ...
    return (
        <>
            <div onClick={()=>{setSaleID("");}} data-testid="close_delet_modal" className="fixed z-10 top-0 left-0 w-screen h-screen bg-black-02 backdrop-blur"></div>
            <div data-testid="delet_modal" className="fixed z-10 flex flex-col justify-between items-center w-2/3 h-96 bottom-1/2 right-1/2 translate-x-1/2 translate-y-1/2 bg-slate-100 p-12 pt-6 rounded-3xl">
