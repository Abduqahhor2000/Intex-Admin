                        ...
                        <div className="flex justify-around w-full">
                            {
                                reqStatus === true ? <span className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-3" style={{"backgroundColor" : "rgba(0, 147, 152, 1)"}}>
                                                   ...
                                                   : <span onClick={()=> {deleteOrder()}} className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-1.5" style={{"backgroundColor" : "rgba(0, 147, 152, 1)"}}>Да</span>
                            }
                            <span onClick={()=>{setSaleID("");}} className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-1.5" style={{"backgroundColor" : "rgb(152, 0, 147)"}}>Нет</span>   
                        </div>
                    </> :
