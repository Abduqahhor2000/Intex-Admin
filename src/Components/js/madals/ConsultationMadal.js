                ...
                </span>
                {
                    ...
                    <>
                        ...
                        <div className="flex justify-around w-full">
                            ...
                            <span onClick={()=> setConsulID("")} className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-1.5" style={{"backgroundColor" : "rgb(152, 0, 147)"}}>Net</span>   
                        </div>
                    </> :
