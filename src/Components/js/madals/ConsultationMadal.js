...
export default function ConsultationMadal({consulID, setConsulID}) {
    ...
    return (
        <>
            <div onClick={()=>{ setConsulID("")}} className="fixed z-10 top-0 left-0 w-screen h-screen bg-black-02 backdrop-blur"></div>
                ...
                </span>
                {
                    ...
                    <>
                        ...
                        <div className="flex justify-around w-full">
                            {
                                reqStatus === true ? <span className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-3 bg-blue-green">
                                                   ...
                                                   : <span onClick={()=> {deleteConsul()}} className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-1.5 bg-blue-green">Да</span>
                            }
                            <span onClick={()=> setConsulID("")} className="block cursor-pointer h-12 rounded-3xl text-3xl text-white px-16 py-1.5 bg-red-blue">Нет</span>   
                        </div>
                    </> :
