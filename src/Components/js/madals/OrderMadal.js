...
export default function OrderMadal({orderMadal, setOrderMadal, orderInfo}) {
    ...
    return(
        <>
            <div onClick={()=> setOrderMadal(false)} className="fixed z-10 top-0 left-0 w-screen h-screen" style={{"background-color": "rgba(0, 0, 0, 0.2)", "backdrop-filter": "blur(7px)"}}></div>
