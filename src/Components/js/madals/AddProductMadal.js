...
export default function AddProductMadal({ setMadal, oneHand, setOneHand }) {
  ...
  const productStatus = useSelector(
    (state) => state.user.productStatus.productStatus
  );
  ...
  const addProduct = async () => {
    ...
    try {
      const { data } = await https({
        ...
        data: {
          categoryId: categoryId ? categoryId : categories[0].category_id,
          productImage,
          price,
          ...
          equipmentRu,
          equipmentUz,
          statusId: statusId ? statusId : productStatus[0].id,
        },
      });
      dispatch(
        addOneProduct({
          ...
          size,
          depth,
          category_id: categoryId ? categoryId : categories[0].category_id,
          image: `${baseURL}${data?.data[0]?.image}`,
          sale_price: salePrice,
          frame_ru: frameRu,
          frame_uz: frameUz,
          status_id: statusId ? statusId : productStatus[0].id,
  ...
  return (
    <>
      <div
        ...
        className="fixed z-10 top-0 left-0 w-screen h-screen backdrop-blur bg-black-02"
      ></div>
      <div className="scrool fixed z-10 flex flex-col justify-between items-center max-h-[90vh] min-h-fit overflow-auto bg-slate-100 p-12 pt-6 pb-9 rounded-3xl inset-0 m-auto w-282.5">
        <span
          onClick={() => {
            setMadal(false);
          }}
          className="absolute top-8 right-8 p-2 rounded-full hover:bg-slate-200 cursor-pointer"
        >
          <svg
          ...
          >
            <rect
              ...
              height="3.11651"
              rx="1.55825"
              transform="matrix(0.727944 0.685636 -0.727944 0.685636 2.55737 0.508789)"
              fill="#B9B9B9"
            />
            <rect
              width="41.3575"
              height="3.11651"
              rx="1.55825"
              transform="matrix(0.727944 -0.685636 0.727944 0.685636 0.00292969 28.5811)"
              fill="#B9B9B9"
            />
          </svg>
        </span>
        {statusReq !== "complate" ? (
          <>
            <div
              className={`relative h-80 flex flex-col cursor-pointer bg-slate-50 justify-center rounded-3xl shadow-lg border-slate-400 border-2 border-dashed mb-6 mt-4 w-172.5 ${
                notRequer && productImage.length < 1 ? "border-red-500" : ""
              }`}
            >
              <input
                onChange={(e) => {
                ...
                type="file"
                className="uploadfile absolute w-full h-full cursor-pointer"
              />
              {productImage ? (
                <img
                ...
                <div className="flex h-80 justify-center items-center text-center">
                  <svg
                    className="mr-7"
                    xmlns="http://www.w3.org/2000/svg"
                    width="86"
                  ...
                  >
                    <path
                      d="M8.0625 0C5.92419 0 3.87346 0.84944 2.36145 2.36145C0.849439 3.87346 0 5.92419 0 8.0625L0 56.4375C0 58.5758 0.849439 60.6265 2.36145 62.1385C3.87346 63.6506 5.92419 64.5 8.0625 64.5H77.9375C80.0758 64.5 82.1265 63.6506 83.6385 62.1385C85.1506 60.6265 86 58.5758 86 56.4375V8.0625C86 5.92419 85.1506 3.87346 83.6385 2.36145C82.1265 0.84944 80.0758 0 77.9375 0H8.0625ZM77.9375 5.375C78.6503 5.375 79.3338 5.65815 79.8379 6.16215C80.3419 6.66615 80.625 7.34973 80.625 8.0625V40.3125L60.3344 29.8474C59.8303 29.5949 59.2596 29.5073 58.703 29.597C58.1465 29.6867 57.6322 29.9492 57.233 30.3472L37.2918 50.2885L22.9942 40.764C22.478 40.4203 21.8588 40.2657 21.2417 40.3265C20.6245 40.3872 20.0473 40.6595 19.608 41.0972L5.38575 53.75V56.6525C5.37932 56.581 5.37574 56.5093 5.375 56.4375V8.0625C5.375 7.34973 5.65815 6.66615 6.16215 6.16215C6.66615 5.65815 7.34973 5.375 8.0625 5.375H77.9375Z"
                      fill="#898989"
                    />
                    <path
                      d="M33.3252 18.8125C33.3252 20.9508 32.4758 23.0015 30.9637 24.5135C29.4517 26.0256 27.401 26.875 25.2627 26.875C23.1244 26.875 21.0737 26.0256 19.5616 24.5135C18.0496 23.0015 17.2002 20.9508 17.2002 18.8125C17.2002 16.6742 18.0496 14.6235 19.5616 13.1115C21.0737 11.5994 23.1244 10.75 25.2627 10.75C27.401 10.75 29.4517 11.5994 30.9637 13.1115C32.4758 14.6235 33.3252 16.6742 33.3252 18.8125Z"
                      fill="#898989"
                    />
                  </svg>
                  <span className="text-3xl py-3.5 text-slate-400">
            ...
            <div className="flex justify-between flex-wrap px-9">
              <div className="relative flex flex-col pl-10 mx-5 mb-3">
                ...
                <select
                  ...
                  className="w-96 h-12 text-3xl text-slate-600 bg-transparent cursor-pointer border-b-2 border-solid border-slate-600"
                >
                  {categories.map((item) => {
                    return (
              ...
              <div className="relative flex flex-col pl-10 mx-5 mb-3">
                ...
                <input
                  ...
                  type="number"
                  className={`w-96 h-12 text-3xl text-slate-600  outline-none border-b-2 border-solid  ${
                    notRequer && quantity.length < 1
                      ? "border-red-500"
                      : "border-slate-600"
                  }`}
                />
              ...
              <div className="relative flex flex-col pl-10 mx-5 mb-3">
                ...
                <input
                  ...
                  type="number"
                  className="w-96 h-12 text-3xl text-slate-600 outline-none border-b-2 border-solid border-slate-600"
                />
              </div>
              <div className="relative flex flex-col pl-10 mx-5 mb-3">
                <svg
              ...
              <div className="relative flex flex-col pl-10 mx-5 mb-3">
                ...
                <label className="text-2xl text-slate-400">
                  Рамка на узбекском <span className="text-red-500">*</span>
                </label>
                <input
                  value={frameUz}
                  maxLength={50}
                  onChange={(e) => {
                    setFrameUz(e.target.value);
                  }}
                  type="text"
                  className={`w-96 h-12 text-3xl text-slate-600 outline-none border-b-2 border-solid ${
                    notRequer && frameUz.length < 1
                      ? "border-red-500"
                      : "border-slate-600"
                  }`}
                />
              ...
              <div className="relative flex flex-col pl-10 mx-5 mb-3">
                ...
                <label className="text-2xl text-slate-400">
                  Глубина(см) <span className="text-red-500">*</span>
                </label>
                <input
                  value={depth}
                  min={0}
              ...
              <div className="relative w-full flex flex-col mx-5 mb-5">
                <input
                  ...
                  maxLength={150}
                  onChange={(e) => {
                    setEquipmentRu(e.target.value);
                  }}
                  type="text"
                  placeholder="Комплектация"
                  className="w-full h-12 text-3xl text-slate-600 outline-none border-b-2 border-solid border-slate-600"
                />
              </div>
            ...
            {statusReq === "active" ? (
              <div className="flex justify-center w-60 rounded-3xl text-white text-2xl text-center py-3 cursor-pointer mt-6 bg-blue-green">
                <svg
                  className="animate-spin mr-3 ml-3 h-5 w-5 text-white"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                >
              ...
              <div
                ...
                className="w-60 rounded-3xl text-white text-2xl text-center pt-1.5 pb-1.5 cursor-pointer mt-6 bg-blue-green"
              >
                Добавить
              </div>
            )}
          ...
          <>
            <div className="flex flex-col items-center">
              <img
                className={`grayscale duration-300 w-40 ${
                  statusReq === "complate" ? "grayscale-0" : ""
                }`}
                src={gr}
                alt=""
              />
