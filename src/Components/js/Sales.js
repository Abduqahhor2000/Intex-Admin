...
export default function Sales () {
    ...
    const updateSales = async (item) => {
        ...
        try{
            ...
            }).then(()=>{ getOrders(token, dispatch, addAllOrders); 
                ...
                <tbody>
                    {
                        orders.map(item => {
                            return (
                                <tr key={item.order_id} className="bg-white text-xl">
                                        ...
                                        <div className="flex">
                                            {
                                                ...
                                                item.status === true ? 
                                                <span onClick={()=>{updateSales(item)}} className="p-2 cursor-pointer">
