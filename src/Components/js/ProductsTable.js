                                ...
                                <>
                                    <tr className="bg-white">
                                        ...
                                        <td className="py-2 flex flex-col justify-center">
                                            <span className="chegirmasiz text-xs after:content-[''] after:rotate-6 after:top-2 after:absolute after:left-1 after:w-1/3 relative inline-block">{item.oldCost}</span>
