...
export default function SaleItem({item, setSaleID}) {
    ...
    return(
        <>
            <tr className="bg-white text-xl" data-testid="sales_item">
                <td className="min-w-pradaja rounded-l-3xl py-1.5 pr-3 pl-10">{item.name}</td>
                <td className="min-w-pradaja py-1.5 px-3">{item.phone_number}</td>
                ...
                <td className="min-w-sena py-1.5 px-3">{numberConvert(item.price)}</td>
                <td className="min-w-pradaja py-1.5 text-base">
                    <span className="w-48 block">{item.address}</span>
                </td>
                <td className="min-w-[11rem] px-3 py-1.5">{timeConvert(item.time_order)}</td>
                    ...
                    <div className="flex">
                        {
                            ...
                            item.status === true ? 
                            <span onClick={()=>{updateSales()}} className="p-2 cursor-pointer">
                        ...
                        <span data-testid="delet_button" onClick={() =>{setSaleID(item.order_id)}} className="p-2 ml-2 cursor-pointer">
