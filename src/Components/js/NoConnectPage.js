    ...
    return(
        <div className="flex justify-center items-center h-screen">
            <div className=" flex flex-col items-center text-3xl mt-5 mr-5">
                <div className="text-9xl mb-5 rotate-90" style={{"color": "#009398"}}><FcCrystalOscillator/></div>
                <div className="text-5xl font-extrabold mb-10" style={{"color": "#009398"}}>No internet connection</div>
